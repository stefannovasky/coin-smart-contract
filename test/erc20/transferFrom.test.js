...
contract('Coin transferFrom method tests', accounts => {
  ...
  it('transferFrom method should alert error when from address is invalid', async () => {
  ...
  it('transferFrom method should alert error when to address is invalid', async () => {
    await Assert.reverts(
  ...
  it('transferFrom method should alert error when balance is insufficient', async () => {
    await Assert.reverts(
  ...
  it('transferFrom method should alert error when sender is not approved', async () => {
    await Assert.reverts(
  ...
  it('transferFrom method should success', async () => {
